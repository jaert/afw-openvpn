...
A: public class StartOpenVPNActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
    	...
    	final String EXTRA_NAME = "be.blinkt.openvpn.shortcutProfileName";

        Intent shortcutIntent = new Intent(Intent.ACTION_MAIN);
		shortcutIntent.setClassName("be.blinkt.openvpn", "be.blinkt.openvpn.LaunchVPN");
...
am start -a android.intent.action.MAIN -n be.blinkt.openvpn/.LaunchVPN -e be.blinkt.openvpn.shortcutProfileName Home
