 ...
 * Original file: /home/jan/werk/onderzoek/mobile_wireless_access_ics/openvpnport/ics-openvpn/remoteExample/src/main/aidl/be/blinkt/openvpn/api/IOpenVPNAPIService.aidl
 */
package be.blinkt.openvpn.api;
public interface IOpenVPNAPIService extends android.os.IInterface
{
/** Local-side IPC implementation stub class. */
public static abstract class Stub extends android.os.Binder implements be.blinkt.openvpn.api.IOpenVPNAPIService
{
private static final java.lang.String DESCRIPTOR = "be.blinkt.openvpn.api.IOpenVPNAPIService";
...
/**
 * Cast an IBinder object into an be.blinkt.openvpn.api.IOpenVPNAPIService interface,
 * generating a proxy if needed.
 */
public static be.blinkt.openvpn.api.IOpenVPNAPIService asInterface(android.os.IBinder obj)
{
if ((obj==null)) {
return null;
}
android.os.IInterface iin = obj.queryLocalInterface(DESCRIPTOR);
if (((iin!=null)&&(iin instanceof be.blinkt.openvpn.api.IOpenVPNAPIService))) {
return ((be.blinkt.openvpn.api.IOpenVPNAPIService)iin);
}
return new be.blinkt.openvpn.api.IOpenVPNAPIService.Stub.Proxy(obj);
}
...
java.util.List<be.blinkt.openvpn.api.APIVpnProfile> _result = this.getProfiles();
...
{
data.enforceInterface(DESCRIPTOR);
be.blinkt.openvpn.api.IOpenVPNStatusCallback _arg0;
_arg0 = be.blinkt.openvpn.api.IOpenVPNStatusCallback.Stub.asInterface(data.readStrongBinder());
...
be.blinkt.openvpn.api.APIVpnProfile _result = this.addNewVPNProfile(_arg0, _arg1, _arg2);
reply.writeNoException();
if ((_result!=null)) {
reply.writeInt(1);
_result.writeToParcel(reply, android.os.Parcelable.PARCELABLE_WRITE_RETURN_VALUE);
...
private static class Proxy implements be.blinkt.openvpn.api.IOpenVPNAPIService
{
...
@Override public java.util.List<be.blinkt.openvpn.api.APIVpnProfile> getProfiles() throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
java.util.List<be.blinkt.openvpn.api.APIVpnProfile> _result;
try {
_data.writeInterfaceToken(DESCRIPTOR);
mRemote.transact(Stub.TRANSACTION_getProfiles, _data, _reply, 0);
_reply.readException();
_result = _reply.createTypedArrayList(be.blinkt.openvpn.api.APIVpnProfile.CREATOR);
}
finally {
_reply.recycle();
_data.recycle();
...
/**
      ...
      */
@Override public void registerStatusCallback(be.blinkt.openvpn.api.IOpenVPNStatusCallback cb) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
/**
     ...
     */
@Override public void unregisterStatusCallback(be.blinkt.openvpn.api.IOpenVPNStatusCallback cb) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
/** Use a profile with all certificates etc. embedded */
@Override public be.blinkt.openvpn.api.APIVpnProfile addNewVPNProfile(java.lang.String name, boolean userEditable, java.lang.String config) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
be.blinkt.openvpn.api.APIVpnProfile _result;
try {
_data.writeInterfaceToken(DESCRIPTOR);
_data.writeString(name);
...
_reply.readException();
if ((0!=_reply.readInt())) {
_result = be.blinkt.openvpn.api.APIVpnProfile.CREATOR.createFromParcel(_reply);
}
else {
_result = null;
}
...
public java.util.List<be.blinkt.openvpn.api.APIVpnProfile> getProfiles() throws android.os.RemoteException;
...
/**
      * Registers to receive OpenVPN Status Updates
      */
public void registerStatusCallback(be.blinkt.openvpn.api.IOpenVPNStatusCallback cb) throws android.os.RemoteException;
/**
     * Remove a previously registered callback interface.
     */
public void unregisterStatusCallback(be.blinkt.openvpn.api.IOpenVPNStatusCallback cb) throws android.os.RemoteException;
/** Remove a profile by UUID */
...
/** Use a profile with all certificates etc. embedded */
public be.blinkt.openvpn.api.APIVpnProfile addNewVPNProfile(java.lang.String name, boolean userEditable, java.lang.String config) throws android.os.RemoteException;
}
