package be.blinkt.openvpn.remote;
...
import be.blinkt.openvpn.api.APIVpnProfile;
import be.blinkt.openvpn.api.IOpenVPNAPIService;
import be.blinkt.openvpn.api.IOpenVPNStatusCallback;
...
public class MainFragment extends Fragment implements View.OnClickListener, Handler.Callback {
    ...
    private void bindService() {
        ...
        icsopenvpnService.setPackage("be.blinkt.openvpn");
