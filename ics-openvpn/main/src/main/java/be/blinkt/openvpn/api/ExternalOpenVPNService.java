...
import be.blinkt.openvpn.core.ConfigParser.ConfigParseError;
import be.blinkt.openvpn.core.OpenVPNService;
import be.blinkt.openvpn.core.OpenVPNService.LocalBinder;
import be.blinkt.openvpn.core.ProfileManager;
import be.blinkt.openvpn.core.VPNLaunchHelper;
    ...
    private final IOpenVPNAPIService.Stub mBinder = new IOpenVPNAPIService.Stub() {
        ...
        private void startProfile(VpnProfile vp)
        {
            ...
            if(vpnPermissionIntent != null || neddPassword != 0){
                ...
                shortVPNIntent.setClass(getBaseContext(), be.blinkt.openvpn.LaunchVPN.class);
                shortVPNIntent.putExtra(be.blinkt.openvpn.LaunchVPN.EXTRA_KEY, vp.getUUIDString());
                shortVPNIntent.putExtra(be.blinkt.openvpn.LaunchVPN.EXTRA_HIDELOG, true);
