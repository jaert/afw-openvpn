...
public class LaunchVPN extends Activity {
    ...
    public static final String EXTRA_KEY = "be.blinkt.openvpn.shortcutProfileUUID";
    public static final String EXTRA_NAME = "be.blinkt.openvpn.shortcutProfileName";
    public static final String EXTRA_HIDELOG = "be.blinkt.openvpn.showNoLogWindow";
