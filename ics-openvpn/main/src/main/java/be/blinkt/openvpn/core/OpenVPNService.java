...
import be.blinkt.openvpn.BuildConfig;
import be.blinkt.openvpn.R;
import be.blinkt.openvpn.VpnProfile;
import be.blinkt.openvpn.activities.DisconnectVPN;
import be.blinkt.openvpn.activities.LogWindow;
import be.blinkt.openvpn.core.VpnStatus.ByteCountListener;
import be.blinkt.openvpn.core.VpnStatus.ConnectionStatus;
import be.blinkt.openvpn.core.VpnStatus.StateListener;

import static be.blinkt.openvpn.core.NetworkSpace.ipAddress;
import static be.blinkt.openvpn.core.VpnStatus.ConnectionStatus.LEVEL_CONNECTED;
import static be.blinkt.openvpn.core.VpnStatus.ConnectionStatus.LEVEL_WAITING_FOR_USER_INPUT;

public class OpenVPNService extends VpnService implements StateListener, Callback, ByteCountListener {
    public static final String START_SERVICE = "be.blinkt.openvpn.START_SERVICE";
    public static final String START_SERVICE_STICKY = "be.blinkt.openvpn.START_SERVICE_STICKY";
    public static final String ALWAYS_SHOW_NOTIFICATION = "be.blinkt.openvpn.NOTIFICATION_ALWAYS_VISIBLE";
    public static final String DISCONNECT_VPN = "be.blinkt.openvpn.DISCONNECT_VPN";
    private static final String PAUSE_VPN = "be.blinkt.openvpn.PAUSE_VPN";
    private static final String RESUME_VPN = "be.blinkt.openvpn.RESUME_VPN";
    ...
    synchronized void unregisterDeviceStateReceiver() {
        if (mDeviceStateReceiver != null)
            try {
                ...
                // java.lang.IllegalArgumentException: Receiver not registered: be.blinkt.openvpn.NetworkSateReceiver@41a61a10
                // Ignore for now ...
                iae.printStackTrace();
            }
    ...
    private OpenVPNManagement instantiateOpenVPN3Core() {
        try {
            Class cl = Class.forName("be.blinkt.openvpn.core.OpenVPNThreadv3");
    ...
    private void doSendBroadcast(String state, ConnectionStatus level) {
        ...
        vpnstatus.setAction("be.blinkt.openvpn.VPN_STATUS");
