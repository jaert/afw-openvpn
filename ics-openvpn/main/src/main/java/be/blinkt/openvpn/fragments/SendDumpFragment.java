...
public class SendDumpFragment extends Fragment  {
	...
	public void emailMiniDumps()
	{
		...
		uris.add(Uri.parse("content://be.blinkt.openvpn.FileProvider/" + ldump.first.getName()));
		uris.add(Uri.parse("content://be.blinkt.openvpn.FileProvider/" + ldump.first.getName() + ".log"));
