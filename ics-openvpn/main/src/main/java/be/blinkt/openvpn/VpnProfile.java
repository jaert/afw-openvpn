...
import be.blinkt.openvpn.core.Connection;
import be.blinkt.openvpn.core.NativeUtils;
...
import be.blinkt.openvpn.core.X509Utils;
...
public class VpnProfile implements Serializable, Cloneable {
    ...
    public static final String EXTRA_PROFILEUUID = "be.blinkt.openvpn.profileUUID";
