...
void Java_be_blinkt_openvpn_core_NativeUtils_jniclose(JNIEnv *env,jclass jo, jint fd)
{
	int ret = close(fd);
}
...
jstring Java_be_blinkt_openvpn_core_NativeUtils_getNativeAPI(JNIEnv *env, jclass jo)
{
